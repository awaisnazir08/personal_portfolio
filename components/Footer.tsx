        ...
        <footer className='w-full pb-10 mb-[100px] md:mb-5' id='contact'>
            <div className='flex flex-col items-center'>
                <h1 className='heading lg:max-w-[45vw]'>
                    Ready to transform <span className='text-purple'> your </span> ideas with the power of AI?
                </h1>
                <p className='text-white-200 md:mt-10 my-5 text-center'>Reach out to me today and let&apos;s discuss how I can help you achieve your goals.</p>
                <a href='mailto:owaisnazir2228@gmail.com'>
            ...
            <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
                <p className='md:text-base text-sm md:font-normal font-light'>
                    Copyright © 2024 Awais Nazir
                </p>
                <div className='flex items-center md:gap-3 gap-6'>
                    {socialMedia.map((profile) => (
                        <a
                        key={profile.id}
                        href={profile.url} // Add this line to link to the URL
                        target="_blank"   // This will open the link in a new tab
                        rel="noopener noreferrer" // This helps with security and performance
