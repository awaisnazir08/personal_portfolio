        ...
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
                ...
                <Card
                    ...
                    des="Once we agree on the plan, I cue my lofi playlist and dive i coding. From initial sketches to polished code, I keep you updated with every step of the way."
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
